<template>
  <div class="category-page">
    ...
    <!-- 页面标题 -->
    <h1>{{ isEnglish ? 'Household Products' : '日用家居' }}</h1>
...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { name:'Storage Box', img:`${import.meta.env.BASE_URL}household/1.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Laundry Basket', img:`${import.meta.env.BASE_URL}household/2.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Clothes Hanger', img:`${import.meta.env.BASE_URL}household/3.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Trash Bin', img:`${import.meta.env.BASE_URL}household/4.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Cleaning Brush', img:`${import.meta.env.BASE_URL}household/5.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Mop', img:`${import.meta.env.BASE_URL}household/6.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Vacuum Storage Bag', img:`${import.meta.env.BASE_URL}household/7.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Toothbrush Holder', img:`${import.meta.env.BASE_URL}household/8.jpg`, price:'$5-$10', moq:'10pcs' }
      ]
    }
  },
  methods: {
