<template>
  <div class="category-page">
    ...
    <!-- 页面标题 -->
    <h1>{{ isEnglish ? 'Gifts & Decorations' : '礼品饰品' }}</h1>
...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { name:'Gift Box', img:`${import.meta.env.BASE_URL}gifts/1.jpg`, price:'$10-$20', moq:'10pcs' },
        { name:'Decorative Candle', img:`${import.meta.env.BASE_URL}gifts/2.jpg`, price:'$10-$20', moq:'10pcs' },
        { name:'Photo Frame', img:`${import.meta.env.BASE_URL}gifts/3.jpg`, price:'$10-$20', moq:'10pcs' },
        { name:'Keychain', img:`${import.meta.env.BASE_URL}gifts/4.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Stuffed Toy', img:`${import.meta.env.BASE_URL}gifts/5.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Greeting Card', img:`${import.meta.env.BASE_URL}gifts/6.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Pen Set', img:`${import.meta.env.BASE_URL}gifts/7.jpg`, price:'$5-$10', moq:'10pcs' },
        { name:'Notebook', img:`${import.meta.env.BASE_URL}gifts/8.jpg`, price:'$5-$10', moq:'10pcs' }
      ]
    }
  },
  methods: {
