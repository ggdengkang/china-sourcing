<template>
  <div class="category-page">
    ...
    <!-- 页面标题 -->
    <h1>{{ isEnglish ? 'Fashion & Accessories' : '时尚配饰' }}</h1>
...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { name:'Handbag', img:`${import.meta.env.BASE_URL}fashion/1.jpg`, price:'$20-$50', moq:'10pcs' },
        { name:'Fashion Watch', img:`${import.meta.env.BASE_URL}fashion/2.jpg`, price:'$20-$50', moq:'10pcs' },
        { name:'Necklace', img:`${import.meta.env.BASE_URL}fashion/3.jpg`, price:'$20-$50', moq:'10pcs' },
        { name:'Sunglasses', img:`${import.meta.env.BASE_URL}fashion/4.jpg`, price:'$20-$50', moq:'10pcs' },
        { name:'Belt', img:`${import.meta.env.BASE_URL}fashion/5.jpg`, price:'$20-$50', moq:'10pcs' },
        { name:'Earrings', img:`${import.meta.env.BASE_URL}fashion/6.jpg`, price:'$20-$50', moq:'10pcs' },
        { name:'Bracelet', img:`${import.meta.env.BASE_URL}fashion/7.jpg`, price:'$20-$50', moq:'10pcs' },
        { name:'Hat', img:`${import.meta.env.BASE_URL}fashion/8.jpg`, price:'$20-$50', moq:'10pcs' }
      ]
    }
  },
  methods: {
