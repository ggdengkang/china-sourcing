<template>
  <div class="category-page">
    ...
    <!-- 页面标题 -->
    <h1>{{ isEnglish ? 'Hardware Tools' : '五金百货' }}</h1>
...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { name:'Hammer', img:`${import.meta.env.BASE_URL}hardware/1.jpg`, price:'$10-$30', moq:'10pcs' },
        { name:'Screwdriver Set', img:`${import.meta.env.BASE_URL}hardware/2.jpg`, price:'$10-$30', moq:'10pcs' },
        { name:'Wrench', img:`${import.meta.env.BASE_URL}hardware/3.jpg`, price:'$10-$30', moq:'10pcs' },
        { name:'Pliers', img:`${import.meta.env.BASE_URL}hardware/4.jpg`, price:'$10-$30', moq:'10pcs' },
        { name:'Tape Measure', img:`${import.meta.env.BASE_URL}hardware/5.jpg`, price:'$10-$30', moq:'10pcs' },
        { name:'Drill', img:`${import.meta.env.BASE_URL}hardware/6.jpg`, price:'$10-$30', moq:'10pcs' },
        { name:'Saw', img:`${import.meta.env.BASE_URL}hardware/7.jpg`, price:'$10-$30', moq:'10pcs' },
        { name:'Level Tool', img:`${import.meta.env.BASE_URL}hardware/8.jpg`, price:'$10-$30', moq:'10pcs' }
      ]
    }
  },
  methods: {
