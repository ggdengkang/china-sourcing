<template>
  <div class="category-page">
    ...
    <!-- 页面标题 -->
    <h1>{{ isEnglish ? 'Electronics' : '电子产品' }}</h1>
...
export default {
      ...
      products: [
  {
    ...
    img:`${import.meta.env.BASE_URL}electronics/1.jpg`,
    price:'$30-$100',
    moq:'10pcs'
  },
  {
    name:'Smart mosquito killer',
    img:`${import.meta.env.BASE_URL}electronics/2.jpg`,
    price:'$30-$100',
    moq:'10pcs'
  },
  {
    name:'Smart selfie stick',
    img:`${import.meta.env.BASE_URL}electronics/3.jpg`,
    price:'$30-$100',
    moq:'20pcs'
  },
  {
    name:'Smart Watch',
    img:`${import.meta.env.BASE_URL}electronics/4.jpg`,
    price:'$30-$100',
    moq:'50pcs'
  },
  {
    name:'Bluetooth Earphones',
    img:`${import.meta.env.BASE_URL}electronics/5.jpg`,
    price:'$50-$100',
    moq:'100pcs'
  },
  {
    name:'Power Bank',
    img:`${import.meta.env.BASE_URL}electronics/6.jpg`,
    price:'$30-$100',
    moq:'50pcs'
  },
  {
    name:'USB Cable',
    img:`${import.meta.env.BASE_URL}electronics/7.jpg`,
    price:'$5-$50',
    moq:'500pcs'
  },
  {
    name:'Smart sand painting',
    img:`${import.meta.env.BASE_URL}electronics/8.jpg`,
    price:'$100-$600',
    moq:'20pcs'
  }
]
