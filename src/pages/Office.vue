<template>
  <div class="category-page">
    ...
    <!-- 页面标题 -->
    <h1>{{ isEnglish ? 'Perfume & Cosmetics' : '香水/化妆品' }}</h1>
...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { name:'Perfume', img:`${import.meta.env.BASE_URL}office/1.jpg`, price:'$50-$100', moq:'10pcs' },
        { name:'Lipstick', img:`${import.meta.env.BASE_URL}office/2.jpg`, price:'$50-$100', moq:'10pcs' },
        { name:'Eyebrow pencil', img:`${import.meta.env.BASE_URL}office/3.jpg`, price:'$20-$30', moq:'10pcs' },
        { name:'Mascara', img:`${import.meta.env.BASE_URL}office/4.jpg`, price:'$20-$30', moq:'10pcs' },
        { name:'Blush', img:`${import.meta.env.BASE_URL}office/5.jpg`, price:'$20-$30', moq:'200pcs' },
        { name:'Eyeshadow Palette', img:`${import.meta.env.BASE_URL}office/6.jpg`, price:'$20-$30', moq:'10pcs' },
        { name:'Nail Polish', img:`${import.meta.env.BASE_URL}office/7.jpg`, price:'$20-$30', moq:'10pcs' },
        { name:'Makeup Brush Set', img:`${import.meta.env.BASE_URL}office/8.jpg`, price:'$20-$30', moq:'10pcs' }
      ]
    }
  },
  methods: {
